...
*/
      ...
      // Read in first 'four' values (32-bit)
      if (K_length >= 1u) { val1 = inPtr[0u*marcoRealBlockSize]; }
      if (K_length >= 2u) { val2 = inPtr[1u*marcoRealBlockSize]; }
      if (K_length >= 3u) { val3 = inPtr[2u*marcoRealBlockSize]; }
      if (K_length >= 4u) { val4 = inPtr[3u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 5u) { val1 = inPtr[4u*marcoRealBlockSize]; }
      if (K_length >= 6u) { val2 = inPtr[5u*marcoRealBlockSize]; }
      if (K_length >= 7u) { val3 = inPtr[6u*marcoRealBlockSize]; }
      if (K_length >= 8u) { val4 = inPtr[7u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >=  9u) { val1 = inPtr[ 8u*marcoRealBlockSize]; } 
      if (K_length >= 10u) { val2 = inPtr[ 9u*marcoRealBlockSize]; }
      if (K_length >= 11u) { val3 = inPtr[10u*marcoRealBlockSize]; }
      if (K_length >= 12u) { val4 = inPtr[11u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 13u) { val1 = inPtr[12u*marcoRealBlockSize]; }
      if (K_length >= 14u) { val2 = inPtr[13u*marcoRealBlockSize]; }
      if (K_length >= 15u) { val3 = inPtr[14u*marcoRealBlockSize]; }
      if (K_length >= 16u) { val4 = inPtr[15u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 17u) { val1 = inPtr[16u*marcoRealBlockSize]; }
      if (K_length >= 18u) { val2 = inPtr[17u*marcoRealBlockSize]; }
      if (K_length >= 19u) { val3 = inPtr[18u*marcoRealBlockSize]; }
      if (K_length >= 20u) { val4 = inPtr[19u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 21u) { val1 = inPtr[20u*marcoRealBlockSize]; }
      if (K_length >= 22u) { val2 = inPtr[21u*marcoRealBlockSize]; }
      if (K_length >= 23u) { val3 = inPtr[22u*marcoRealBlockSize]; }
      if (K_length >= 24u) { val4 = inPtr[23u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 25u) { val1 = inPtr[24u*marcoRealBlockSize]; }
      if (K_length >= 26u) { val2 = inPtr[25u*marcoRealBlockSize]; }
      if (K_length >= 27u) { val3 = inPtr[26u*marcoRealBlockSize]; }
      if (K_length >= 28u) { val4 = inPtr[27u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 29u) { val1 = inPtr[28u*marcoRealBlockSize]; }
      if (K_length >= 30u) { val2 = inPtr[29u*marcoRealBlockSize]; }
      if (K_length >= 31u) { val3 = inPtr[30u*marcoRealBlockSize]; }
      if (K_length >= 32u) { val4 = inPtr[31u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 33u) { val1 = inPtr[32u*marcoRealBlockSize]; }
      if (K_length >= 34u) { val2 = inPtr[33u*marcoRealBlockSize]; }
      if (K_length >= 35u) { val3 = inPtr[34u*marcoRealBlockSize]; }
      if (K_length >= 36u) { val4 = inPtr[35u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 37u) { val1 = inPtr[36u*marcoRealBlockSize]; }
      if (K_length >= 38u) { val2 = inPtr[37u*marcoRealBlockSize]; }
      if (K_length >= 39u) { val3 = inPtr[38u*marcoRealBlockSize]; }
      if (K_length >= 40u) { val4 = inPtr[39u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 41u) { val1 = inPtr[40u*marcoRealBlockSize]; }
      if (K_length >= 42u) { val2 = inPtr[41u*marcoRealBlockSize]; }
      if (K_length >= 43u) { val3 = inPtr[42u*marcoRealBlockSize]; }
      if (K_length >= 44u) { val4 = inPtr[43u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 45u) { val1 = inPtr[44u*marcoRealBlockSize]; }
      if (K_length >= 46u) { val2 = inPtr[45u*marcoRealBlockSize]; }
      if (K_length >= 47u) { val3 = inPtr[46u*marcoRealBlockSize]; }
      if (K_length >= 48u) { val4 = inPtr[47u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 49u) { val1 = inPtr[48u*marcoRealBlockSize]; }
      if (K_length >= 50u) { val2 = inPtr[49u*marcoRealBlockSize]; }
      if (K_length >= 51u) { val3 = inPtr[50u*marcoRealBlockSize]; }
      if (K_length >= 52u) { val4 = inPtr[51u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 53u) { val1 = inPtr[52u*marcoRealBlockSize]; }
      if (K_length >= 54u) { val2 = inPtr[53u*marcoRealBlockSize]; }
      if (K_length >= 55u) { val3 = inPtr[54u*marcoRealBlockSize]; }
      if (K_length >= 56u) { val4 = inPtr[55u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 57u) { val1 = inPtr[56u*marcoRealBlockSize]; }
      if (K_length >= 58u) { val2 = inPtr[57u*marcoRealBlockSize]; }
      if (K_length >= 59u) { val3 = inPtr[58u*marcoRealBlockSize]; }
      if (K_length >= 60u) { val4 = inPtr[59u*marcoRealBlockSize]; }
      ...
      // Read in next 'four' values (32-bit)
      if (K_length >= 61u) { val1 = inPtr[60u*marcoRealBlockSize]; }
      if (K_length >= 62u) { val2 = inPtr[61u*marcoRealBlockSize]; }
      if (K_length >= 63u) { val3 = inPtr[62u*marcoRealBlockSize]; }
...
//if (threadIdx.x < BlockSize) // marco
      ...
      uint chunkIdx   = (bid * marcoRealBlockSize) + tid;					// Get starting index within chunk
