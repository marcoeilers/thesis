...
printf("%i\t%i\t%f\t%f\t%f\t%f\n", num_elements, BINS, time1 / num_elements, time2 / num_elements, time3 / num_elements, (time1 + time2 + time3) / num_elements);
}
...
int size = ((((1 << 26) / WORK_PER_BLOCK) * WORK_PER_BLOCK) / 1024 ) * 1024;
